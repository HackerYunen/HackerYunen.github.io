...
canvas.attr('style','position: fixed; opacity: 0.7; right: 50px; bottom: -20px; z-index: 99999;');
$("#content-outer").append(canvas); 

$("#cola").attr('onclick','color()');
$("#shutiao").attr('onclick','colorAndCrisps()');
